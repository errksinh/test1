                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="form3Example3c">Quantity</label>
                      <input type="text" id="form3Example3c" class="form-control" name="qty" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <input type="text" id="form3Example4cd" class="form-control" name="desc"/>
                      
                    </div>
                  </div>

                  <input type="submit" value="clickme"/>    
                  <a href="<?php echo e(route('products.index')); ?>">Index</a>
